...
public class SeatBookingPage extends TestBase {
    ...
    @FindBy(xpath ="//div[@class = 'fltLeg']/div[2]/div[2]/div[1]")
    ...
    @FindBy(xpath = "//*[@id=\"depart-cal\"]/div[4]/div[2]/div[3]/div[3]")
    ...
    public boolean verifyTheBookingRefNo() throws InterruptedException {
    	Thread.sleep(5000);
